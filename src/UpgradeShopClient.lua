...
local function UpdateResponsiveSizing()
	...
	if IsSmall then
		...
		CategoryFrame.UIListLayout.Wraps = true

		UpgradeList.Position =
			UDim2.fromOffset(16, 194)

		UpgradeList.Size =
			UDim2.new(1, -32, 1, -210)
	else
		ShopFrame.Size =
			UDim2.fromOffset(720, 540)

		CategoryFrame.Size =
			UDim2.new(1, -32, 0, 42)

		CategoryFrame.UIListLayout.Wraps = false

		UpgradeList.Position =
			UDim2.fromOffset(16, 154)

		UpgradeList.Size =
			UDim2.new(1, -32, 1, -170)
	end
end
